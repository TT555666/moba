<template>
  <div v-if="model" class="page-hero">
    ...
    <div class="topbar bg-black py-2 px-3 d-flex ai-center text-white">
      <img src="~assets/mobaImg/logo.png" alt="logo" height="30" />
      <!-- 左边 -->
      <span class="px-2">王者荣耀</span>
      <span class="px-2 flex-1">攻略站</span>
      <!-- 右边 -->
    ...
    <div class="top" :style="{'background-image':`url(${model.banner})`}">
      <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
        ...
        <div class="d-flex jc-between ai-center">
          ...
          <router-link to="/" class="text-grey" tag="span">皮肤：7 &gt;</router-link>
        </div>
      </div>
    </div>
    <!-- 英雄初识 进阶攻略 -->
      ...
      <swiper>
        <swiper-slide>
          <div>
            ...
            <tt-card plain icon="menu1" title="出装推荐" class="hero-items">
            ...
            <tt-card plain icon="menu1" title="使用技巧">
              <p class="m-0">{{model.usageTips}}</p>
            </tt-card>
            <tt-card plain icon="menu1" title="对抗技巧">
              <p class="m-0">{{model.battleTips}}</p>
            </tt-card>
            <tt-card plain icon="menu1" title="团战思路">
              <p class="m-0">{{model.teamTips}}</p>
            </tt-card>
            <tt-card plain icon="menu1" title="英雄关系">
